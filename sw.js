const CACHE_VERSION='d1-rc2-shell-v6';
const RUNTIME_CACHE='d1-rc2-runtime-v6';
const APP_SHELL=[
  './','./index.html','./styles.css','./app.js','./rc2-core.js','./rc2-discovery.js','./rc2-data.js','./rc2-bulk.js','./rc2-seed.js','./manifest.webmanifest','./install-qr.png','./icons/icon.svg','./icons/icon-192.png','./icons/icon-512.png','./icons/apple-touch-icon.png','./data/routes-pdh.json','./data/geometry-pdh.json','./data/seed-ha-tien.json'
];
